#!/usr/bin/env python3
"""
Vision Transformer Inference for Breast Cancer Ultrasound Segmentation
Simple and efficient inference pipeline for ViT-based segmentation
"""
...
from vit_segmentation import ViTUNetSegmentation


class ViTInference:
    """
    Inference class for ViT segmentation model
    Handles loading, preprocessing, and prediction
    """

    def __init__(self, checkpoint_path: str = "checkpoints/best_vit_model.pth", device: str = "auto"):
        """
    ...
    def _load_model(self, checkpoint_path: str) -> ViTUNetSegmentation:
        """Load trained model from checkpoint"""

        # Create model
        model = ViTUNetSegmentation(pretrained=False)
...
def main():
    """Command-line interface for ViT inference"""

    parser = argparse.ArgumentParser(description="ViT Breast Cancer Segmentation Inference")
    ...
    parser.add_argument("--checkpoint", "-c", default="checkpoints/best_vit_model.pth",
    ...
    inference = ViTInference(args.checkpoint)
